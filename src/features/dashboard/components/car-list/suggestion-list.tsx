...
export function SuggestionList() {
    ...
    return (
        <div className='flex flex-col justify-start lg:pl-4 pr-2 space-y-3 pt-3'>
            <span className='text-md font-bold' style={{ color: "#012169" }}>We couldn’t find any cars matching your search — try exploring these instead!</span>
            <PagedGrid<Car>
                className="pb-2"
                hasScrollBar={false}
                rowCount={4}
